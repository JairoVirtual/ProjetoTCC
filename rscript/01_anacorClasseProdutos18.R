# ====================================================================#
# Arquivo  : 01_anacorClasseProdutos18.R
# Descricao: Dados de 2018 filtrados com investidores com conhecimento
#            básico em educação financeira (Acertou as perguntas da variável
#            (P20),(P21) e (P22) do arquivo ed01.zip da Anbima), também 
...
#Carregando a base de dados 2018
...
My.db.sqlite <-         # nome do dataframe, ex: My.db.sqlite
  here::here(
    "data",
    "produced_data",         # local onde esta a base de dados salva
    "db.DB18.SQLITE"    # base de dados que sera lida
  )
...
# para ver as tabelas existentes na base
dbListTables(my_con)
