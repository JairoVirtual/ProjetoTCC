# ====================================================================#
# Arquivo  : 05_anacorClasseProdutos22.R
# Descricao: Dados de 2022 filtrados com investidores com conhecimento
#            básico em educação financeira (Acertou as perguntas da variável
#            (P20),(P21) e (P22) do arquivo ed05.zip da Anbima), também 
...
#Carregando a base de dados 2022
...
My.db.sqlite <-         # nome do dataframe, ex: My.db.sqlite
  here::here(
    ...
    "db.DB22.SQLITE"    # base de dados que sera lida
  )
