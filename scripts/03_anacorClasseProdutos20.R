# ====================================================================#
# Arquivo  : 03_anacorClasseProdutos20.R
# Descricao: Dados de 2020 "COM filtro" NÃO PASSOU NO TESTE QUI-QUADRADO.
...
#            (P20),(P21) e (P22) do arquivo ed03.zip da Anbima), mas com
...
#Carregando a base de dados 2020
...
My.db.sqlite <-         # nome do dataframe, ex: My.db.sqlite
  here::here(
    ...
    "db.DB20.SQLITE"    # base de dados que sera lida
  )
